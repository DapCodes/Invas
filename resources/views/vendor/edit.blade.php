...
@section('page-title', 'Data Vendor / Ubah')
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">Ubah data vendor</h5>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" id="vendor-name"
                                    placeholder="PT ABC Jaya" value="{{ old('name', $vendor->name) }}" required />
                            </div>
                            @error('name')
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input name="code" type="text" id="vendor-code" class="form-control @error('code') is-invalid @enderror"
                                    placeholder="Kode Vendor" value="{{ old('code', $vendor->code) }}" />
                            </div>
                            @error('code')
                                <div class="invalid-feedback d-block mt-1 d-flex gap-1" style="margin-left: 15px;">
                                    <i class="bx bx-error-circle"></i>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input name="phone" type="text" id="vendor-phone" class="form-control @error('phone') is-invalid @enderror"
                                    placeholder="08123456789" value="{{ old('phone', $vendor->phone) }}" />
                            </div>
                            @error('phone')
                                <div class="invalid-feedback d-block mt-1 d-flex gap-1" style="margin-left: 15px;">
                                    <i class="bx bx-error-circle"></i>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <textarea name="address" id="vendor-address" class="form-control @error('address') is-invalid @enderror"
                                    placeholder="Jl. Merdeka No. 123, Jakarta" rows="2">{{ old('address', $vendor->address) }}</textarea>
                            </div>
                            @error('address')
                                <div class="invalid-feedback d-block mt-1 d-flex gap-1" style="margin-left: 15px;">
                                    <i class="bx bx-error-circle"></i>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <textarea name="description" id="vendor-description" class="form-control @error('description') is-invalid @enderror"
                                    placeholder="Keterangan vendor..." rows="3">{{ old('description', $vendor->description) }}</textarea>
                            </div>
                            @error('description')
                                <div class="invalid-feedback d-block mt-1 d-flex gap-1" style="margin-left: 15px;">
                                    <i class="bx bx-error-circle"></i>
